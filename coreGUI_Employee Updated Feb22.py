...
def LeBingo(): #Used to change music from app only !
    Music()
...
def settingcr():
    setting1 = [[sg.T('SETTING')],
                ...
                [sg.Button('Change Current Music')]]
...
while True :
    ...
    if event == 'Advanced':
        ...
        while True:
            ...
            if event == 'Update':
                if (values['EMPSAL1']) == None or values['EMPSAL1'] == '' or values['AOWSAL1'] == '':
